...
export const updateInstitutionSignupReq = async (data) => {
  try {
    const res = await publicAxios.put(`${ApiKey.InstitutionSignup}`, data);
...
export const deleteInstitutionSignupReq = async (actionId) => {
  try {
    const res = await publicAxios.delete(`${ApiKey.InstitutionSignup}/${actionId}`);
